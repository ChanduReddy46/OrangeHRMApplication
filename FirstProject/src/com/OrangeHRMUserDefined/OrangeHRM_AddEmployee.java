...
public class OrangeHRM_AddEmployee  extends BaseTest{
	...
	{
	FileInputStream logInTestDataFile = new FileInputStream("./src/com/OrangeHRM_LoginMultipleTestData/AddEmployee.xlsx");
...
*/
	...
	By welcomeProperty=By.id("welcome");
	    ...
	    FileOutputStream testResultFile = new FileOutputStream("./src/com/OrangeHRM_LoginMultipleTestData/AddEmployeeTestResult1.xlsx");
